package com.rjchakraborty.notificationcodes;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener(new OnSuccessListener<InstanceIdResult>() {
            ...
            public void onSuccess(InstanceIdResult instanceIdResult) {
                ...
                if (mToken != null && !TextUtils.isEmpty(mToken)) {
                    SharedPrefer.saveString(SharedPrefer.FCM_TOKEN, mToken);
                }
            }
        });
    ...
    private void requestReadAndSendSmsPermission() {
        ...
        ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.SEND_SMS, Manifest.permission.READ_SMS, Manifest.permission.RECEIVE_SMS},
                SMS_PERMISSION_CODE);
    }
}